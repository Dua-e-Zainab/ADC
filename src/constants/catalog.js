...
export const CAT = {
  PLASTIC: {
    DEBIT: {
      ...
      VISA: {
        "VISA CLASSIC": ["VC MEGA NFC PRIMARY 2", "VC MEGA NFC SUPPLY 2", "VISA READY LINE NFC"],
        ...
        "VISA AMEEN INFINITE (ISLAMIC)": ["VC AMEEN INFINITE NFC PRI", "VC AMEEN INFINITE NFC SUPPLY"], "VISA PREMIUM PLUS (CONVENTIONAL)": ["VC PREMIUM PLUS NFC PRI", "VC PREMIUM PLUS NFC SUPPLY"],
        ...
        "VISA AMEEN FREELANCER (ISLAMIC)": ["VISA FREE LANCER NFC AMEEN", "VISA FREE LANCER NFC AMEEN SUPPLY", "VC AMEEN FCY AED NFC", "VC AMEEN FCY EUR NFC", "VC AMEEN FCY GBP NFC", "VC AMEEN FCY SAR NFC", "VC AMEEN FCY USD NFC", "VC AMEEN FREELANCER NFC PRI", "VC AMEEN FREELANCER NFC SUPPLY"], "VISA UAE CLASSIC": ["UAE VISA CLASSIC NFC"],
  ...
  ENVELOPE: {
    DEBIT: {
      ...
      VISA: {
        ...
        "VISA CLASSIC AMEEN": ["VC AMEEN NFC PRI", "VC AMEEN NFC SUPPLY"],
        "VISA WOMEN (CONVENTIONAL)": ["VC WOMEN NFC PRI", "VC WOMEN NFC SUPPLY"],
        "VISA AMEEN WOMEN (ISLAMIC)": ["VC AMEEN WOMEN NFC PRI", "VC AMEEN WOMEN NFC SUPPLY"],
        "VISA INFINITE (CONVENTIONAL)": ["VC INFINITE NFC PRI", "VC INFINITE NFC SUPPLY"],
        "VISA AMEEN INFINITE (ISLAMIC)": ["VISA AMEEN INFINITE (ISLAMIC)"],
        "VISA PREMIUM PLUS (CONVENTIONAL)": ["VC PREMIUM PLUS NFC PRI", "VC PREMIUM PLUS NFC SUPPLY"],
        "VISA AMEEN PREMIUM PLUS (ISLAMIC)": ["VC AMEEN PREMIUM PLUS NFC PRI", "VC AMEEN PREMIUM PLUS NFC SUPPLY"],
        "VISA FREELANCER (CONVENTIONAL)": ["VC FREE LANCER NFC PRI", "VISA FREE LANCER NFC SUPPLY", "VC FCY AED NFC PRI", "VC FCY EUR NFC PRI", "VC FCY GBP NFC PRI", "VC FCY SAR NFC PRI", "VC FCY USD NFC PRI"],
        "VISA AMEEN FREELANCER (ISLAMIC)": ["VISA FREE LANCER NFC AMEEN", "VISA FREE LANCER NFC AMEEN SUPPLY", "VC AMEEN FCY AED NFC", "VC AMEEN FCY EUR NFC", "VC AMEEN FCY GBP NFC", "VC AMEEN FCY SAR NFC", "VC AMEEN FCY USD NFC"],
        "VISA UAE CLASSIC": ["UAE VISA CLASSIC NFC"],
        "VISA UAE PAYROLL": ["UAE PAY ROLL (WIZ) NFC"],
        "VISA UAE SIGNATURE PLATINUM": ["UAE SIGNATURE (PLATINUM) NFC"],
...
export const VENDORS = ["Rayyan Co", "Secure Print", "Info Tel", "Idemia", "Other"];
// add this at the bottom
export const SESSION_KEY = "ims_current_site";
export const SITE_USERS = {
  KHI: { label: "Karachi", username: "...", password: "..." },
  LHE: { label: "Lahore", username: "...", password: "..." },
  ALL: { label: "All Sites (Admin)" },
};